...
class TestCases_WithoutTen
{
    ...
    {
        testcaseMap.put(0, "withoutTen([1, 10, 10, 2]) → [1, 2, 0, 0]");
        testcaseMap.put(1, "withoutTen([10, 2, 10]) → [2, 0, 0]");
        testcaseMap.put(2, "withoutTen([1, 99, 10]) → [1, 99, 0]");
    }
...
public class WithoutTen
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            if (resultsArray[i] != TestCases_WithoutTen.expectedResults[i])
            {
