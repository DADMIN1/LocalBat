...
class TestCases_Post4
{
    ...
    {
        testcaseMap.put(0, "post4([2, 4, 1, 2])");
        testcaseMap.put(1, "post4([4, 1, 4, 2])");
        testcaseMap.put(2, "post4([4, 4, 1, 2, 3])");
    }
...
public class Post4
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            if (!resultsArray[i].equals(TestCases_Post4.expectedResults[i]))
            {
