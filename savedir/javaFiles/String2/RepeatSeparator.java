...
class TestCases_RepeatSeparator
{
    ...
    {
        testcaseMap.put(0, "repeatSeparator(\"Word\", \"X\", 3) → \"WordXWordXWord\"");
        testcaseMap.put(1, "repeatSeparator(\"This\", \"And\", 2) → \"ThisAndThis\"");
        testcaseMap.put(2, "repeatSeparator(\"This\", \"And\", 1) → \"This\"");
    }
