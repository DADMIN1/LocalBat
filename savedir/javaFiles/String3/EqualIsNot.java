...
public final class EqualIsNot
{
    ...
    public static final void main(String[] args) {
        //_EqualIsNot.printSuccesses = false;  // set 'false' to print failing tests only.
        //_EqualIsNot.getStacktraces = true;  // set 'true' for stacktraces on exceptions.
        _EqualIsNot.Validate();
    }
}
