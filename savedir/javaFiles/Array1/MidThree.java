...
class TestCases_MidThree
{
    ...
    {
        testcaseMap.put(0, "midThree([1, 2, 3, 4, 5])");
        testcaseMap.put(1, "midThree([8, 6, 7, 5, 3, 0, 9])");
        testcaseMap.put(2, "midThree([1, 2, 3])");
    }
...
public class MidThree
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            if (!resultsArray[i].equals(TestCases_MidThree.expectedResults[i]))
            {
