...
class TestCases_SwapEnds
{
    ...
    {
        testcaseMap.put(0, "swapEnds([1, 2, 3, 4]) → [4, 2, 3, 1]");
        testcaseMap.put(1, "swapEnds([1, 2, 3]) → [3, 2, 1]");
        testcaseMap.put(2, "swapEnds([8, 6, 7, 9, 5]) → [5, 6, 7, 9, 8]");
    }
...
public class SwapEnds
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            if (resultsArray[i] != TestCases_SwapEnds.expectedResults[i])
            {
