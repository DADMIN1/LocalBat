...
class TestCases_MakeMiddle
{
    ...
    {
        testcaseMap.put(0, "makeMiddle([1, 2, 3, 4]) → [2, 3]");
        testcaseMap.put(1, "makeMiddle([7, 1, 2, 3, 4, 9]) → [2, 3]");
        testcaseMap.put(2, "makeMiddle([1, 2]) → [1, 2]");
    }
...
public class MakeMiddle
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            if (resultsArray[i] != TestCases_MakeMiddle.expectedResults[i])
            {
