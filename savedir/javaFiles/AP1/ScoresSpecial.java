...
class TestCases_ScoresSpecial
{
    ...
    {
        testcaseMap.put(0, "scoresSpecial([12, 10, 4], [2, 20, 30]) → 40");
        testcaseMap.put(1, "scoresSpecial([20, 10, 4], [2, 20, 10]) → 40");
        testcaseMap.put(2, "scoresSpecial([12, 11, 4], [2, 20, 31]) → 20");
    }
