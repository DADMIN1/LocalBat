...
class TestCases_MergeTwo
{
    ...
    {
        testcaseMap.put(0, "mergeTwo([\"a\", \"c\", \"z\"], [\"b\", \"f\", \"z\"], 3)");
        testcaseMap.put(1, "mergeTwo([\"a\", \"c\", \"z\"], [\"c\", \"f\", \"z\"], 3)");
        testcaseMap.put(2, "mergeTwo([\"f\", \"g\", \"z\"], [\"c\", \"f\", \"g\"], 3)");
    }
...
public class MergeTwo
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            if (!resultsArray[i].equals(TestCases_MergeTwo.expectedResults[i]))
            {
