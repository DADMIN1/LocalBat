...
class TestCases_CopyEndy
{
    ...
    {
        testcaseMap.put(0, "copyEndy([9, 11, 90, 22, 6], 2) → [9, 90]");
        testcaseMap.put(1, "copyEndy([9, 11, 90, 22, 6], 3) → [9, 90, 6]");
        testcaseMap.put(2, "copyEndy([12, 1, 1, 13, 0, 20], 2) → [1, 1]");
    }
...
public class CopyEndy
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            if (resultsArray[i] != TestCases_CopyEndy.expectedResults[i])
            {
