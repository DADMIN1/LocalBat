...
class TestCases_SumHeights
{
    ...
    {
        testcaseMap.put(0, "sumHeights([5, 3, 6, 7, 2], 2, 4)");
        testcaseMap.put(1, "sumHeights([5, 3, 6, 7, 2], 0, 1)");
        testcaseMap.put(2, "sumHeights([5, 3, 6, 7, 2], 0, 4)");
    }
