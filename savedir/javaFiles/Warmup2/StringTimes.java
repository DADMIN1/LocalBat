package Warmup2;
import Warmup2.Testcases._StringTimes;
...
public final class StringTimes
{
    ...
    public static final void main(String[] args) {
        //_StringTimes.printSuccesses = false;  // set 'false' to print failing tests only.
        //_StringTimes.getStacktraces = true;  // set 'true' for stacktraces on exceptions.
        _StringTimes.Validate();
    }
}
