...
public final class AlarmClock
{
    ...
    public static final void main(String[] args) {
        //_AlarmClock.printSuccesses = false;  // set 'false' to print failing tests only.
        //_AlarmClock.getStacktraces = true;  // set 'true' for stacktraces on exceptions.
        _AlarmClock.Validate();
    }
}
